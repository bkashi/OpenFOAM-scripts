...
print "Mesh I Time:   ", latestI
print "Mesh II Time:  ", latestII
print "Mesh III Time: ", latestIII
...
set autoscale y
set key top right
plot	 './'.caseI.'/postProcessing/sampleDict/'.latestI.'/wallData.xy' skip 2 using ($1/d) : (-mu*$6/(0.5*rho*u*u)) with lines lw 3 dt 1 lc rgb "green" title 'Mesh I', \
		 './'.caseII.'/postProcessing/sampleDict/'.latestII.'/wallData.xy' skip 2 using ($1/d) : (-mu*$6/(0.5*rho*u*u)) with lines lw 3 dt 2 lc rgb "blue" title 'Mesh II', \
		 './'.caseIII.'/postProcessing/sampleDict/'.latestIII.'/wallData.xy' skip 2 using ($1/d) : (-mu*$6/(0.5*rho*u*u)) with lines lw 3 dt 3 lc rgb "red" title 'Mesh III'
